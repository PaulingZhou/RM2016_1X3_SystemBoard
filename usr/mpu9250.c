...
uint8_t MPU9250_Init(void)
{
	...
	if(MPU9250_Read_Reg(WHO_AM_I)==0x73){
		...
		MPU9250_Write_Reg(XG_OFFSET_H,0x00);
		MPU9250_Write_Reg(XG_OFFSET_L,0x00);
		MPU9250_Write_Reg(YG_OFFSET_H,0x00);
		MPU9250_Write_Reg(YG_OFFSET_L,0x00);
		MPU9250_Write_Reg(ZG_OFFSET_H,0x00);
		MPU9250_Write_Reg(ZG_OFFSET_L,0x00);
		return 1;
	}
	return 0;
}
